...
- **tutorial-ui:** `[Check package.json in Task 0]`

**Target Version (after milestone completion):**

- **tutorial-ui:** `[VERSION].N` (where N = number of tasks)
...
- **tutorial-ui:** `{developer}-MMDDYY-[VERSION]-ui`
...
- `git checkout -b {developer}-MMDDYY-[VERSION]-ui`
- `git push -u origin {developer}-MMDDYY-[VERSION]-ui`
...
**Branch Naming Format:** `{developer}-MMDDYY-[VERSION]-ui`
